 ...
 *
 *  The scroll itself is handled centrally by RootLayout's RouteScroll, which
 *  is mounted inside the routed <main> so the destination section is already
 *  in the DOM by the time it runs.
 * --------------------------------------------------------------------------*/
