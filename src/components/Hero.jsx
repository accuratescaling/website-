      ...
      <div className="container-x relative">
        ...
        >
          ...
          >
            ...
            {/* as="link" + a fully-qualified target, not a bare "#services" anchor:
              * a raw hash link never reaches React Router, so the shell's scroll
              * handling is skipped and the router's location goes stale. */}
            <Button
              as="link"
              to="/#services"
              variant="ghost"
